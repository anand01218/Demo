...
const WelcomePackagePage = () => {
  ...
  const handleSend = () => {
    router.push("/settings/onboarding/welcome-package/preview");
  };
      ...
      <MetaData pageTitle="Welcome Package">
        <Wrapper>
          <div className="app__slide-wrapper">
            ...
            <div className="col-span-12 mt-2 bg-white dark:bg-gray-800 px-6 py-6 shadow-sm border border-gray-200 dark:border-gray-600">
