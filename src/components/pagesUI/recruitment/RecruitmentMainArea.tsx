    ...
    <>
      <div className="app__slide-wrapper">
        ...
        <div className="bg-white border border-gray-200 dark:border-gray-600 shadow-lg dark:bg-gray-800 rounded-sm overflow-hidden">
          {/* Enhanced Header */}
          <div className="bg-white dark:bg-gray-800 px-6 py-3 border-b border-gray-200 dark:border-gray-600">
              ...
              <div className="flex items-center space-x-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 w-64 border border-gray-400 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none shadow-sm transition-all duration-200"
                  />
                </div>
                <button
          ...
          <div className="flex h-full gap-4">
            <div className="flex-1 bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-600 overflow-hidden">
              <RecruitmentView searchTerm={searchTerm} />
            </div>
          </div>
        </div>
      </div>
