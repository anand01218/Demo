    ...
    <>
      <div className="card__wrapper">
        <div className="card__title-wrap mb-[20px]">
          <h5 className="card__heading-title mb-2.5">
            Box Step with Variation
          </h5>
          <p>
            A steps-item with classname <code>.done </code> A steps-item with
            classname <code>.error </code> A steps-item with classname{" "}
            <code>.active </code> A steps-item with classname{" "}
            <code>.disabled </code>
          </p>
        </div>
        <div className="steps-grid-4">
          <div className="steps-item done">
          ...
          <div className="steps-item error">
            <span className="steps-number">
          ...
          <div className="steps-item disabled">
            <span className="steps-number">
