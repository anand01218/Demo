      ...
      <div className="app__slide-wrapper">
        ...
        <div className="grid grid-cols-12 gap-x-6 maxXs:gap-x-0">
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-light">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-dark">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-bookmark ribbon-info">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-bookmark ribbon-dark">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-clip ribbon-info">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-clip ribbon-warning">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-clip ribbon-danger">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-clip ribbon-light">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              <div className="ribbon__wrapper">
                <div className="ribbon ribbon-clip ribbon-dark">Ribbon</div>
              </div>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam
              dolorem alias doloremque consectetur repudiandae officiis!
            </div>
