    ...
    <>
      <div className="card__wrapper no-height">
        ...
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-12 from__input-box">
            <div className="form__input-title">
              <label htmlFor="html5-url-input2">
                Url<span>*</span>
              </label>
            </div>
            <div className="form__input">
          ...
          <div className="col-span-12 from__input-box">
            <div className="form__input-title">
              <label htmlFor="exampleFormControlReadOnlyInput2">
                Read only Box
              </label>
            </div>
            <div className="form__input">
          ...
          <div className="col-span-12 from__input-box">
            <div className="form__input-title">
              <label htmlFor="exampleFormControlReadOnlyInputPlain2">
                Read plain
              </label>
            </div>
            <div className="form__input">
