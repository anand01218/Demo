          ...
          <div className="form__input">
            <div className="input-group form__element-xs">
              ...
              <input
                ...
                placeholder="Left Side Button"
                aria-label="Text with button"
                aria-describedby="button-left-side"
              />
            </div>
          </div>
        </div>
          ...
          <div className="form__input">
            <div className="input-group form__element-xs">
              ...
              <input
                type="text"
                className="form-control"
                placeholder="Left Side Double Button"
                aria-label="Text with double button"
              />
            </div>
          </div>
        </div>
          ...
          <div className="form__input">
            <div className="input-group form__element-xs">
              <input
                type="text"
                className="form-control"
                placeholder="Right Side Button"
                aria-label="Text with button"
                aria-describedby="button-right-side"
              />
              <button
                className="btn btn-outline-primary"
                type="button"
