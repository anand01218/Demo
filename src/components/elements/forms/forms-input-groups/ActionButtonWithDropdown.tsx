...
const ActionButtonWithDropdown = () => {
  ...
  const [anchorElTwo, setAnchorElTwo] = useState<HTMLButtonElement | null>(
    null
  );
  const [anchorElThree, setAnchorElThree] = useState<HTMLButtonElement | null>(
    null
  );
    ...
    <div className="card__wrapper">
      ...
      <div className="from__input-box">
        <div className="input-group">
          ...
          >
            <MenuItem onClick={() => handleCloseMenu(setAnchorElTwo)}>
              Action
            </MenuItem>
            <MenuItem onClick={() => handleCloseMenu(setAnchorElTwo)}>
              More Action
      ...
      <div className="from__input-box">
        <div className="input-group">
          ...
          >
            <MenuItem onClick={() => handleCloseMenu(setAnchorElThree)}>
              Action
            </MenuItem>
            <MenuItem onClick={() => handleCloseMenu(setAnchorElThree)}>
              More Action
