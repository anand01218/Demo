        ...
        <div className="grid grid-cols-12 gap-x-6 maxXs:gap-x-0">
            ...
            <div className="card__wrapper">
              <div className="card__title-wrap mb-[20px]">
                <h5 className="card__heading-title">
                  Popover Basic Directions
                </h5>
              </div>
              <div className="flex flex-wrap items-center gap-1">
                <button
                  onClick={(event) => handleClickOne(event, "top")}
                  type="button"
                ...
                <button
                  onClick={(event) => handleClickOne(event, "right")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on right
                ...
                <button
                  onClick={(event) => handleClickOne(event, "bottom")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on bottom
                ...
                <button
                  onClick={(event) => handleClickOne(event, "left")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on left
          ...
          <div className="col-span-12 xl:col-span-6">
            <div className="card__wrapper">
              ...
              <div className="flex flex-wrap items-center gap-1">
                <button
                  onClick={(event) => handleClickTwo(event, "top")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on top
                ...
                <button
                  onClick={(event) => handleClickTwo(event, "right")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on right
                ...
                <button
                  onClick={(event) => handleClickTwo(event, "bottom")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on bottom
                ...
                <button
                  onClick={(event) => handleClickTwo(event, "left")}
                  type="button"
                  className="btn btn-primary"
                >
                  Popover on left
