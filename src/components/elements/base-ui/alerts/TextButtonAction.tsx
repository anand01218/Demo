        ...
        <div className="dismiss-text">
          {alerts.primary && (
            <div className="alert alert-primary inverse-bg inverse-primary alert-dismissible fade show">
              ...
              <p>
                Your time is over after <b>5</b> minutes.
              </p>
              <button className=" btn-text-close bg-primary" type="button">
                <span onClick={() => closeAlert("primary")}>dismiss</span>
              </button>
            </div>
          )}
          {alerts.secondary && (
            <div className="alert alert-secondary inverse-bg inverse-secondary alert-dismissible fade show">
              ...
              <button className="btn-text-close bg-secondary" type="button">
                <span onClick={() => closeAlert("secondary")}>dismiss</span>
              </button>
            </div>
          )}
          {alerts.success && (
            <div className="alert alert-success inverse-bg inverse-success alert-dismissible fade show">
              ...
              <button className="btn-text-close bg-success" type="button">
                <span onClick={() => closeAlert("success")}>dismiss</span>
              </button>
            </div>
          )}
          {alerts.info && (
            <div className="alert alert-info inverse-bg inverse-info alert-dismissible fade show">
              ...
              <button className="btn-text-close bg-info" type="button">
                <span onClick={() => closeAlert("info")}>dismiss</span>
              </button>
            </div>
          )}
          {alerts.warning && (
            <div className="alert alert-warning inverse-bg inverse-warning alert-dismissible fade show">
              <i className="icon-bell" />
              <p>
                <b>Congratulations!</b> Your product was added to the like list.
              </p>
              <button className="btn-text-close bg-warning" type="button">
                <span onClick={() => closeAlert("warning")}>dismiss</span>
              </button>
            </div>
          )}
          {alerts.danger && (
            <div className="alert alert-danger inverse-bg inverse-danger alert-dismissible fade show">
              ...
              <p>
                Your <b>performance</b> is down this week.
              </p>
              <button className="btn-text-close bg-danger" type="button">
                <span onClick={() => closeAlert("danger")}>dismiss</span>
              </button>
            </div>
          )}
          {alerts.light && (
            <div className="alert alert-light inverse-bg inverse-light alert-dismissible fade show">
              <i className="icon-triangle-exclamation txt-dark" />
              <p>You can check in on some of those fields below.</p>
              <button
                className="btn-text-close bg-light"
                type="button"
                onClick={() => closeAlert("light")}
              >
                <span className=" text-dark dark:text-white">dismiss</span>
              </button>
            </div>
          )}
          {alerts.dark && (
