            ...
            <div className="card__wrapper no-height">
              ...
              <div className="">
                <div className="ratio ratio-21x9">
                  <iframe src="https://www.youtube.com/embed/IyR_uYsRdPs?si=cRVsyYlGOP9dL066" />
                </div>
              </div>
            </div>
          ...
          <div className="col-span-12 xl:col-span-6">
            ...
            <div className="card__wrapper no-height">
              <div className="card__title-wrap mb-[20px]">
                ...
                <p>
                  Use class <code>{`style="--bs-aspect-ratio: 50%;"`}</code>
                </p>
              </div>
              <div className="">
