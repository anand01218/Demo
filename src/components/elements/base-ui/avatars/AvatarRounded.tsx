        ...
        <div className="avatar-showcase">
          <div className="avatars flex items-center gap-[10px] sm:gap-[20px]">
            <div className="avatar">
              <Image
                className="w-[100px] rounded-circle"
                priority
                src={avatarImg}
                alt="image"
              />
            ...
            <div className="avatar">
              <Image
                className="w-[90px] rounded-circle"
                priority
                src={avatarImg}
                alt="image"
              />
            ...
            <div className="avatar">
              <Image
                className="w-[80px] rounded-circle"
                priority
                src={avatarImg}
                alt="image"
              />
            ...
            <div className="avatar">
              <Image
                className="w-[70px] rounded-circle"
                priority
                src={avatarImg}
                alt="image"
              />
            ...
            <div className="avatar">
              <Image
                className="w-[30px] rounded-circle"
                priority
                src={avatarImg}
                alt="image"
              />
            ...
            <div className="avatar">
              <Image
                className="w-[24px] rounded-circle"
                priority
                src={avatarImg}
                alt="image"
              />
