        ...
        <div className="grid grid-cols-12 gap-x-6 maxXs:gap-x-0">
          ...
          <div className="col-span-12">
            <div className="card__wrapper">
              ...
              <div>
                <p className="mb-0">
                  This is an example paragraph to showcase some
                  ...
                  with tooltips. The text here serves as a demonstration,
                  providing context and substance. The main goal is to
                  illustrate how
                  <Tooltip title="Additional Information" placement="top" arrow>
                    <Link href="#" className="text-primary">
                      {" "}
                  ...
                  can be effectively used in practice, whether on your
                  <Tooltip title="Additional Information" placement="top" arrow>
                    <Link href="#" className="text-primary">
                      {" "}
                      own site
