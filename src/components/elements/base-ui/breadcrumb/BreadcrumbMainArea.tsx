              ...
              <div className="">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb breadcrumb-style2 flex items-center mb-0">
                    <li className="breadcrumb-item">
                      <Link href="#">
                        <i className="icon-house me-1 text-[15px] d-inline-block" />
                        Home
                      </Link>
                    </li>
                    <li className="breadcrumb-item">
                      <Link href="#">
                        <i className="icon-grid-2-plus me-1 text-[15px] d-inline-block" />
                        About
                      </Link>
                    </li>
                    <li className="breadcrumb-item active" aria-current="page">
            ...
            <div className="card__wrapper">
              ...
              <div className="">
                ...
                <ol className="breadcrumb flex items-center breadcrumb-colored bg-dark dark:bg-dark-dark">
                  <li className="breadcrumb-item dark:!text-headingPrimary dark:before:!text-headingPrimary">
                    <Link href="#" className="dark:!text-headingPrimary">
                      Home
                    </Link>
                  </li>
                  <li
                    className="breadcrumb-item active dark:!text-headingPrimary dark:before:!text-headingPrimary"
                    aria-current="page"
                  >
                    Library
                  </li>
