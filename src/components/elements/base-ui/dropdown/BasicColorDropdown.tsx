          ...
          <div className="dropdown-basic flex flex-wrap items-center gap-1">
            <div className="dropdown">
              <div className="btn-group mb-0">
                <button className="dropbtn btn-primary" type="button">
                  Action{" "}
                  <span>
            ...
            <div className="dropdown">
              <div className="btn-group mb-0">
                <button className="dropbtn btn-secondary" type="button">
                  Action{" "}
                  <span>
                    <i className="icon-arrow-down" />
                  </span>
            ...
            <div className="dropdown">
              <div className="btn-group mb-0">
                <button className="dropbtn btn-success" type="button">
                  Action{" "}
                  <span>
                    <i className="icon-arrow-down" />
                  </span>
            ...
            <div className="dropdown">
              <div className="btn-group mb-0">
                <button className="dropbtn btn-info" type="button">
                  Action{" "}
                  <span>
                    <i className="icon-arrow-down" />
                  </span>
            ...
            <div className="dropdown">
              <div className="btn-group mb-0">
                <button className="dropbtn btn-warning txt-dark" type="button">
                  Action{" "}
                  <span>
                    <i className="icon-arrow-down" />
                  </span>
            ...
            <div className="dropdown">
              <div className="btn-group mb-0">
                <button className="dropbtn btn-danger" type="button">
                  Action{" "}
                  <span>
                    <i className="icon-arrow-down" />
                  </span>
