    ...
    <>
      <div className="card__wrapper">
        ...
        <div className="flex flex-wrap gap-2">
          <span className="bd-badge border-radius-none bg-primary">
            Primary
          </span>
          <span className="bd-badge border-radius-none bg-secondary">
            Secondary
          </span>
          <span className="bd-badge border-radius-none bg-success">
            Success
          </span>
          <span className="bd-badge border-radius-none bg-danger">Danger</span>
          <span className="bd-badge border-radius-none bg-warning">
            Warning
          </span>
          ...
          <span className="bd-badge border-radius-none bg-dark text-white">
            Dark
          </span>
        </div>
      </div>
