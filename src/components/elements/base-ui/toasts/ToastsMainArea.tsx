          ...
          <div className="col-span-12 xl:col-span-6 xxl:col-span-12">
            <div className="card__wrapper">
              ...
              <div className="flex flex-wrap items-center gap-1">
                <button
                  onClick={handleClick("variationOne")}
                  className="btn btn-primary"
                >
                  Show Top Center
                </button>
                <button
                  onClick={handleClick("variationTwo")}
                  className="btn btn-primary"
                >
                  Show Bottom Center
                </button>
                <button
                  onClick={handleClick("variationThree")}
                  className="btn btn-primary"
                >
                  Show Bottom Left
                </button>
                <button
                  onClick={handleClick("variationFour")}
                  className="btn btn-primary"
                >
                  Show Top Left
                </button>
                <button
                  onClick={handleClick("variationFive")}
                  className="btn btn-primary"
                >
                  Show Top Right
                </button>
                <button
                  onClick={handleClick("variationSix")}
                  className="btn btn-primary"
                >
                  Show Bottom Right
                </button>
