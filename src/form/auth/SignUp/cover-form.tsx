...
const SignUpCoverForm = () => {
  ...
  // eslint-disable-next-line no-unused-vars -- Parameter required by useForm onSubmit signature, reserved for future API integration
  const onSubmit = async (_data: ISignUpForm) => {
    try {
