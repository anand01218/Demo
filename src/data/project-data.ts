...
const projectData: IProject[] = [
  {
    ...
    completeTask: 10,
    description:
      "Laravel is a popular PHP framework known for its elegant syntax, powerful tools, and developer-friendly environment.",
  ...
  },
  {
    ...
    completeTask: 7,
    description:
      "Revamping the user interface and user experience of a leading e-commerce website to improve customer satisfaction and increase sales.",
  ...
  },
  {
    ...
    completeTask: 8,
    description:
      "Building an AI-powered chatbot to enhance customer support capabilities and provide 24/7 assistance to users.",
  ...
  },
  {
    ...
    completeTask: 11,
    description:
      "Migrating the company's IT infrastructure and applications to the cloud to improve scalability, security, and performance.",
